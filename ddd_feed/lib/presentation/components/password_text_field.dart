import 'package:ddd_feed/presentation/components/custom_card.dart';
        ...
        CustomCard(
          ...
          child: Theme(
            data: ThemeData(
              ...
              colorScheme: ColorScheme.fromSwatch().copyWith(secondary: Theme.of(context).colorScheme.secondary),
            ),
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: GestureDetector(
                  ...
                  child: Icon(
                    obscureText ? Ionicons.eye_off_outline : widget.suffix,
                    size: 15.0,
                    color: AppColors.greyDark,
                  ),
                ),
